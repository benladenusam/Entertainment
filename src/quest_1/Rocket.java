 ...
 * @author m-sev
 */
public class Rocket extends Mashine {
    ...
    public Rocket(String name, int currentSpeed, String type, int mass, int passQuantity, int meansTransmissionMovementQuantity) {
